              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Bánh mì, mì tôm ăn liền, trứng rán, cơm chiên.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Đặt hàng ngay 
          ...
          <div class="col-md-6  ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <a href="">
                 Đặt hàng ngày <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                    <g>
                      <g>
                        <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248
                     c29.184,0,53.248-23.552,53.248-53.248C398.336,362.926,374.784,338.862,345.6,338.862z" />
      ...
      <div class="filters-content">
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all">
            <a href="quantri2.php?page=chitietsp&id=<?php echo $row['prd_id']?>">
            <div class="box">
              <div>
                <div class="img-box">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Phần này giới thiệu thương hiệu, nghĩ sau!
            </p>
            <a href="">
              Đọc thêm
            </a>
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                   Khách hàng nhận xét...vv. Đại loại kiểu review
                </p>
                <h6>
                  sasimi ( Tên của kh)
                </h6>
                <p>
                  okinozawa tokuda  (Tên của kh)
                </p>
              </div>
              <div class="img-box">
