...
<div class="Cart-body" id="listCart">
<h1>Giỏ hàng</h1>
<div class="shopping-cart" id="cartx">
  ...
  <div class="product">
    ...
    <div class="product-price"><?php echo $value["price"]?><u>đ</u></div>
    <div class="product-quantity">
    <input type="number" onchange="updateCart(<?php echo $key ?>)" id="quantity_<?php echo $key ?>" name="quantity_<?php echo $key ?>" value="<?php echo $value["num"] ?>">
    </div>
    <div class="product-removal">
      <button class="remove-product" onclick="deleteCart(<?php echo $key?>)">
        Xóa
      </button>
    </div>
    <div class="product-line-price"><?php echo $value["price"]*$value["num"];$total += $value["price"]*$value["num"] ?></div>
  </div>
  <!--    -->
 ...
 <?php }} ?>  
  ...
  <div class="totals">
    <div class="totals-item totals-item-total">
      <label>Toàn bộ</label>
      <div class="totals-value" ><?php echo $total ?></div>
    </div>
  </div> 
  <div class="bill-button">
      <a href="check-out.php" class="checkout">Thanh Toán</a>
</div>
</div>
</div>
</div>
...
<footer class="footer_section" style="background-color:black;">
    <div class="container">
      ...
      <div class="footer-info">
        <p>
          © <span id="displayYear">2021</span> Quyền 
          <a href="https://html.design/">Free Html Templates</a><br><br>
          © <span id="displayYear"></span> Phân phối bởi
