						...
						<?php
							...
							while ($row = mysqli_fetch_assoc($query) ) { ?>
								<tr>
									...
									<td>
										<a href="quantri.php?page_layout=sua&id=<?php echo $row['prd_id']; ?>">Sửa</a>
									</td>
									<td>
										<a onclick="return Del('<?php echo $row['prd_name']; ?>')" href="quantri.php?page_layout=xoa&id=<?php echo $row['prd_id']; ?>">Xóa</a>
									</td>
								</tr>
							<?php } ?>
					</tbody>
