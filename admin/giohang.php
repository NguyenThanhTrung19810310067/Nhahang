...
<!--kết thúc header-->
		...
		<div class="card">
			<div class="card-header">
				<h2 style="display: inline-block;">Giỏ hàng</h2>
					<form style="display: inline-block; float: right; margin-bottom: -50px;">
					...
					<tbody>
						...
						?>
								<tr>
									...
									?></td>
									<td>
										<a href="quantri.php?page_layout=chitiet&id=<?php echo $row['donhang_id']; ?>">Chi tiết</a>
									</td>
									<td>
										<a onclick="return Del('<?php echo $row['tenkhach']; ?>')" href="quantri.php?page_layout=xoadon&id=<?php echo $row['donhang_id']; ?>">Xóa</a>
									</td>
								</tr>
						<?php } ?>	
					</tbody>
	...
	<script>
		function Del(name){
			return confirm("Bạn có chắc muốn đơn hàng của" +name+ " ?");
		}
	</script>
	  <!-- footer section -->
